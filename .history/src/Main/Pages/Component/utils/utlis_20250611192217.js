...
export const splitSenderName = (fullName) => {
  ...
  const displayedFirstName = firstName.length > 9 ? firstName.substring(0, 7) + '..' : firstName;

  return displayedFirstName;
};

export const formatTimestamp = (timestamp, timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone) => {
...
=======
// export const ApiEndPoint = "http://localhost:5001/api/";
>>>>>>> c80e7ffabbb0f32098078a4c02df72265d173c64
...
export const formatMessageDate = (isoDate, timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone) => {
