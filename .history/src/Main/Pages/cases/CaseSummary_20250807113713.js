...
=======
    ...
    const filteredCases = casesData.cases.filter(caseItem => {
        ...
        const assignedUserFilter = filters.assignedUser === "" ||
            caseItem.AssignedStaff.some(staff => staff.userId === filters.assignedUser);
        ...
        datasets: [
            {
                label: "Cases",
                data: [
                    filteredCases.filter(c => c.RequestDate).length,
                    filteredCases.filter(c => c.VerdictDate).length
                ],
...
>>>>>>> 405f927d20914e60b8cc697f01ac11519df3b75d
    }
  };
                                                ...
                                                <div className="d-flex justify-content-around mt-2">
                                                    {keyDatesBarData.labels.map((label, index) => (
                                                        <div key={index} className="text-center">
                                                            <div className="text-white small">{label}</div>
                                                            <div className="text-white fw-bold">
                                                                {keyDatesBarData.datasets[0].data[index]}
                                                            </div>
                                                        </div>
                                                    ))}
                                                </div>
                                                ...
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <h5 className="mb-0 text-white">
                                                        ...
                                                        {filters.assignedUser ?
                                                            `${casesData.assignedUsers.find(u => u.userId === filters.assignedUser)?.name || 'Selected Lawyer'} Cases` :
                                                            'All Lawyers Cases'}
                                                    </h5>
                                                    {filters.assignedUser && (
                                                    ...
                                                    <div className="d-flex justify-content-around mt-2">
                                                        {keyDatesLineData.labels.map((label, index) => (
                                                            <div key={index} className="text-center">
                                                                <div className="text-white small">{label}</div>
                                                                <div className="text-white fw-bold">
                                                                    {keyDatesLineData.datasets[0].data[index]}
                                                                </div>
                                                            </div>
                                                        ))}
                                                    </div>
