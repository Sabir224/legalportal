    ...
    return (
        <>
            <div className="d-flex justify-content-start gap-1 mb-3">
                <button className="btn btn-sm border" onClick={() => handlefilterbutton("All")} style={{ backgroundColor: buttonSelected === "All" ? '#c0a262' : buttonColor, color: 'white' }}>All</button>
                <button className="btn btn-sm border" onClick={() => handlefilterbutton("Client")} style={{ backgroundColor: buttonSelected === "Client" ? '#c0a262' : buttonColor, color: 'white' }}>Clients</button>
                <button className="btn btn-sm border" onClick={() => handlefilterbutton("Team")} style={{ backgroundColor: buttonSelected === "Team" ? '#c0a262' : buttonColor, color: 'white' }}>Team</button>
            </div>
