        ...
        <table className="table-fixed w-full border border-gray-400">
          <thead>
            <tr className="bg-gray-200 text-gray-700">
              ...
              <th className="border border-gray-400 p-2 w-1/7 text-center">Legal Consultants</th>
            </tr>
          </thead>
          <tbody>
            {(parties?.Parties_body || []).map((party) => {
              const consultants = party?.Legal_Consultants?.Legal_Consultants_header || [];
                      ...
                      <td colSpan="5">
                        <div className="overflow-x-auto mt-2 p-2 bg-gray-100 border border-gray-400">
                          ...
                          {consultants.length > 0 ? (
                            <table className="table-fixed w-full border border-gray-300">
                              <thead>
                                <tr className="bg-gray-200 text-gray-700">
                                  ...
                                  <th className="border border-gray-300 p-2">Date of Disconnection</th>
                                  <th className="border border-gray-300 p-2">City</th>
                                  <th className="border border-gray-300 p-2">Address</th>
                                  <th className="border border-gray-300 p-2">Tel</th>
                                  <th className="border border-gray-300 p-2">Fax</th>
                            ...
                            <p className="text-gray-600 italic">No legal consultants available.</p>
                          )}
                        </div>
                      </td>
                    </tr>
