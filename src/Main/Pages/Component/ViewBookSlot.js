                ...
                >
                    <div className="client-section p-3 text-white">
                        ...
                        <div className="client-details">
                            ...
                            >
                                <FontAwesomeIcon icon={faCalendar} size="1x" color="white" className="m-2" />
                                ...
                                <p
                                    style={{
                                        ...
                                        display: "flex",
                                        alignItems: "center",
                                        gap: "8px", // Yeh gap dega "Meeting:" aur time slot ke beech
                                    }}
                                >
                                    Meeting Time:
                                    <span style={{ color: "#f39c12", marginLeft: "6px" }}>
                        ...
                        <p style={{ color: "#ffffff", fontSize: "16px", textAlign: "center" }}>
                            <a
                                ...
                                onMouseEnter={(e) => {
                                    ...
                                    // Hover background (light golden)

                                }}
                                onMouseLeave={(e) => {
                                    e.target.style.background = "#c0a262"; // Reset to default
