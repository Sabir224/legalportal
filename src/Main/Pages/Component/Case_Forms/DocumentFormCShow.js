...
import ViewDocumentsAndAdd from "../Casedetails/ViewDocumentsAndAdd";
...
import MoveFolderModal from "../Casedetails/MoveFolderModal";
import movefolder from "../Casedetails/Icons/movefolder.png";
import ErrorModal from "../../AlertModels/ErrorModal";

const DocumentFormCShow = ({ token }) => {
    ...
    const fetchFolders = async () => {
        ...
        try {
            ...
            // Apply the same logic in case of error
            let fallbackFolder;
            if (!FormCDetails) {
                fallbackFolder = {
                    _id: "personal-folder",
...
export default DocumentFormCShow;
