                                            ...
                                            if (key === "checklist") {
                                                ...
                                                content = (
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            handleUserClick(
                                                                todo.userId?.value,
                                                                todo.userName?.value || "Unknown User"
                                                            )
                                                        }
                                                    >
                                                ...
                                                content = (
                                                    <TextField
                                                        ...
                                                        value={
                                                            value
                                                                ? new Date(new Date(value).toISOString().split("T")[0])
                                                            ...
                                                            if (key === "documents" || key === "relatedDocsFiles") {
                                                                ...
                                                                content = (
                                                                    <FormControl fullWidth size="small" sx={{ mt: 0.5 }}>
                                                                        ...
                                                                        >
                                                                            {value && Object.entries(value).map(([checkKey, checkValue]) => (
                                                                                <MenuItem
                                                                                    key={checkKey}
                                                                                    disabled
